...
public class WeatherServiceBase
     ...
     */
    private final String mAppid = "04d50db294c38b92f000993bda1d87d5";
    ...
    protected List<WeatherData> getWeatherResults(String location) {
        ...
        // TODO -- you fill in here.
        if (weatherCache.get(location) == null) {
            weatherCache.put(location, getResultsFromWeatherService(location), DEFAULT_CACHE_TIMEOUT);
        }
