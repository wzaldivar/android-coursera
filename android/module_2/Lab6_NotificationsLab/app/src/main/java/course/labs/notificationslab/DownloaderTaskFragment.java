...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> resourceIDSArrayList = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
        Integer[] resourceIDS = new Integer[resourceIDSArrayList.size()];
        resourceIDS = resourceIDSArrayList.toArray(resourceIDS);
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (getResultCode() != MainActivity.IS_ALIVE) {
                            ...
                            PendingIntent pendingIntent = PendingIntent.getActivity(context, MY_NOTIFICATION_ID, restartMainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
